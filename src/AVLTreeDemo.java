/**
 * @ClassName BinaryTree-AVLTree
 * @Author Holden_—__——___———____————_____Xiao
 * @Create 2021年9月05日9:51 - 周日
 * @Theme
 */
...
class Node {
    ...
    public void add(Node node) {
        ...
        //当添加完一个节点后，如果（右子树高度-左子树高度）> 1，右旋转
